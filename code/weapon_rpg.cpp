...
void CMissile::AccelerateThink( void )
{
	...
	SetThink(&CMissile::BoomerThink); //jc429 make RPG act like a boomerang instead of seeking the laser pointer
...
// Boomeranger
//----------------------------------------------------------------------------
void CMissile::BoomerThink( void )
{
	Vector vecForward;
