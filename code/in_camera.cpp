...
#define PITCH_MAX 270.0
#define PITCH_MIN 180.0
...
// ev8 not sure what these are for //jc429 I tried screwing with these to change the camera but nothing changed so I left them alone
...
void CInput::CAM_Think( void )
{
	...
	m_vecCameraOffset[ PITCH ] = camOffset[ PITCH ]+180;
	m_vecCameraOffset[ YAW ]   = camOffset[ YAW ]+180;
...
void CInput::CAM_SetCameraThirdData( CameraThirdData_t *pCameraData, const QAngle &vecCameraOffset )
{
	...
	m_vecCameraOffset[PITCH] = vecCameraOffset[PITCH]+180;
	m_vecCameraOffset[YAW] = vecCameraOffset[YAW]+180;
...
void CInput::CAM_CameraThirdThink( void )
{
	...
	m_vecCameraOffset[PITCH] = vecCamOffset[PITCH]+180;
	m_vecCameraOffset[YAW] = vecCamOffset[YAW]+180;
